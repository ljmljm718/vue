  ...
  >
    <div class="w-full flex justify-between items-center">
      <div class="flex items-center">
        <!-- 一级标题名字 -->
        <h1 class="m-0 text-[#333] font-bold text-[18px]">销售出库</h1>
    ...
    >
      ...
      <el-form-item label="收款状态" prop="receiptStatus">
        <el-select v-model="queryParams.receiptStatus" placeholder="请选择有款状态" clearable>
    ...
    <div class="w-full mt-[16px]">
      ...
      >
        ...
        <el-table-column label="操作" align="center" fixed="right" min-width="210px">
          <template #default="scope">
