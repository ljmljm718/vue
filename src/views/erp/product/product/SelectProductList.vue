...
<template>
  ...
  <!-- 列表 -->
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :stripe="true" :show-overflow-tooltip="true" ref="suibian" @select="fangfa"  @selection-change="handleSelectionChange">
...
const emits = defineEmits<{
  (e: 'success', value: ProductVO[]): void
}>()
const submitForm = () => {
  try {
