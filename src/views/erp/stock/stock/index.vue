  ...
  >
    <div class="w-full flex justify-between items-center">
      <div class="flex items-center">
        <!-- 一级标题名字 -->
        <h1 class="m-0 text-[#333] font-bold text-[18px]">产品库存</h1>
        ...
        -->
        <el-button type="primary" @click="openForm('create')" v-hasPermi="['erp:stock:create']">
      ...
      <div class="flex items-center">
        ...
        <el-button @click="handleExport" :loading="exportLoading" v-hasPermi="['erp:stock:export']">
        ...
        <el-table-column label="操作" align="center" fixed="right" min-width="154px">
          <template #default="scope">
            <div class="flex items-center justify-center">
              <el-button link type="primary" @click="openWarnForm(scope.row.id)">
                预警配置
              </el-button>
            </div>
          </template>
