<template>
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="基地名称" prop="parkName">
            <el-input v-model="formData.parkName" placeholder="选择设备后自动填入基地名称"
                      disabled/>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="地块名称" prop="plotName">
            <el-input v-model="formData.plotName" placeholder="选择设备后自动填入地块名称"
                      disabled/>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="病虫害种类" prop="diseaseType">
            <el-select v-model="formData.diseaseType" clearable placeholder="选择预警信息自动填入病虫害种类" disabled>
              <el-option
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="阈值下限" prop="warnLowValue">
            <el-input v-model="formData.warnLowValue" placeholder="选择预警信息自动填入阈值下限" disabled/>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="阈值上限" prop="warnHighValue">
            <el-input v-model="formData.warnHighValue" placeholder="选择预警信息自动填入阈值上限" disabled/>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="监测周期" prop="monitorPeriod">
            <el-input v-model="formData.monitorPeriod" placeholder="选择预警信息自动填入监测周期" disabled/>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
  ...
  <SelectDiseaseThresholdRuleFrom ref="purchaseOrderInEnableListRefA"
...
import SelectDiseaseThresholdRuleFrom
  from "@/views/agriculture/diseasethresholdrule/SelectDiseaseThresholdRuleFrom.vue";
