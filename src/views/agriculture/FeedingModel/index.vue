  ...
  <div class="flex justify-center">
    <div class="container box-border px-[10px] py-[10px]">
      <div class="w-100% px-[25px] py-[15px] box-border bg-[#fff] rounded">
        ...
        <div
          :class="`grid grid-cols-7 2xl:grid-cols-7 xl:grid-cols-7 lg:grid-cols-5 md:grid-cols-3  sm:grid-cols-1 gap-5 ${FeedingTopList.length} mt-[15px] `"
        >
          <div
          ...
          >
            ...
            <div>
              <div
                :class="`mb-6px text-15px color-[${growthPeriod == item.growthPeriod ? '#fff' : '#000'}]`"
              >
                {{ item.growthPeriod }}
              </div>
            ...
            <div class="w-83%">
              <div class="flex items-center">
                ...
                <div class="text-14px color-[#009688]">
                  投喂频率：
                  <span class="color-[#000]">{{ periodObj.feedingFrequency }}</span>
                </div>
              </div>
              ...
              <div class="flex items-center">
                ...
                <div class="text-14px color-[#009688]">
                  投喂时间：
                  <span class="color-[#000]">{{ periodObj.feedingTime }}</span>
                </div>
              </div>
              <div class="w-2px h-15px bg-[#1fa296] ml-[3px]"></div>
              <div class="flex items-center">
                ...
                <div class="text-14px color-[#009688]">
                  注意事项：
                  <span class="color-[#000]">{{ periodObj.precautions }}</span>
                </div>
              </div>
              <div class="w-2px h-15px bg-[#1fa296] ml-[3px]"></div>
              <div class="flex items-center">
                ...
                <div class="text-14px color-[#009688]">
                  投喂建议：
                  <span class="color-[#000]">{{ periodObj.feedingAdvice }}</span>
                </div>
              </div>
              <div class="w-2px h-15px bg-[#1fa296] ml-[3px]"></div>
              <div class="flex items-center">
                ...
                <div class="text-14px color-[#009688]">
                  投喂饲料：
                  <span class="color-[#000]">{{ periodObj.feedingFood }}</span>
                </div>
              </div>
            </div>
      ...
      <div class="flex justify-between mt-15px">
        <div class="w-49.5% box-border p-[20px] bg-[#fff]">
          ...
          <div>
            <div
              :class="`2xl:flex xl:grid xl:grid-cols-7 2xl:justify-evenly lg:grid lg:grid-cols-4 md:grid md:grid-cols-3 w-full bg-[#f5f5f5]`"
            >
              <div
            ...
            <div
              class="w-100% h-150px sm:h-100px box-border px-[15px] py-[15px] mt-20px bg-[#f5f5f5] factor-meassage"
            >
              {{ influence }}
            </div>
          </div>
        ...
        <div class="w-49.5% box-border p-[20px] bg-[#fff]">
          ...
          <div
            class="2xl:flex 2xl:justify-between xl:flex xl:justify-between box-border lg:grid lg:grid-cols-2 lg:gap-3 md:grid md:grid-cols-1 sm:grid sm:grid-cols-1 px-15px py-15px bg-[#ebf7f7]"
          >
            ...
            <div class="2xl:w-32% xl:w-32% lg:w-100% md:w-100% sm:w-100%">
              ...
              >
                ...
                <div class="color-[#009688]">{{ item?.dataValue }} {{ item?.dataUnit }}</div>
              </div>
            </div>
            <div class="2xl:w-32% xl:w-32% lg:w-100% md:w-100% sm:w-100%">
              <div
          ...
          <div
            class="2xl:flex 2xl:justify-between 2xl:items-center xl:flex xl:justify-between xl:items-center sm:grid sm:grid-cols-1 sm:gap-4 md:grid md:grid-cols-1 md:gap-4 my-15px"
          >
            <div
