  ...
  >
    <div class="w-full flex justify-between items-center">
      <div class="flex items-center">
        <!-- 一级标题名字 -->
        <h1 class="m-0 text-[#333] font-bold text-[18px]">农事记录</h1>
    ...
    >
      ...
      <el-form-item label="基地名称" prop="parkName">
        <el-input v-model="queryParams.parkName" disabled placeholder="请选择所属基地">
          <template #append>
      ...
      <el-form-item label="地块名称" prop="plotName">
        <el-input v-model="queryParams.plotName" disabled placeholder="请选择所属地块">
          <template #append>
        ...
        <el-table-column label="操作" align="center" fixed="right" min-width="154px">
          <template #default="scope">
            <div class="flex items-center justify-center">
              ...
              <el-button link type="primary" @click="openForm('select', scope.row.id)">
                详情
              </el-button>
              <div class="mx-[12px] w-[1px] h-[24px] bg-[#e6e6e6]"></div>
              <el-button
