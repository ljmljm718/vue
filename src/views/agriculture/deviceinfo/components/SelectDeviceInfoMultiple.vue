<template>
  <Dialog title="设备多选" v-model="dialogVisible" :appendToBody="true" :scroll="true" width="1400">
    <ContentWrap>
      <!-- 搜索工作栏 -->
      <el-form class="-mb-15px" :model="queryParams" ref="queryFormRef" :inline="true" label-width="68px">
        ...
        <el-form-item label="设备类型" prop="deviceType">
          <el-cascader style="width: 100%" v-model="deviceType" :options="categoryOptions" :props="categoryProps" />
        </el-form-item>
        ...
        <el-form-item>
          ...
          <el-button type="primary" plain @click="openForm('create')" v-hasPermi="['agriculture:device-info:create']">
    ...
    <ContentWrap>
      ...
      >
        ...
        <el-table-column label="地块名称" align="center" prop="parkDetailName" width="180" />
...
const deviceSelectorTableRef = ref();
const selectClick = (row) => {
  const selectData = selectionList.value;
  if (!deviceSelectorTableRef.value) return;
  const selectedItemFlag = selectData.findIndex((item) => item.id === row.id);
  deviceSelectorTableRef.value.toggleRowSelection(row, selectedItemFlag === -1);
};
