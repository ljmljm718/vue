            ...
            <el-table-column label="操作" align="center" fixed="right" min-width="154px">
              <template #default="scope">
                <div class="flex items-center justify-center">
                  <el-button link type="primary" @click="getCheckLog(scope.row)">
                    巡检日志
                  </el-button>
                  <div class="mx-[12px] w-[1px] h-[24px] bg-[#e6e6e6]"></div>
                  <el-button link type="primary" @click="openFormA('create', scope.row)">
                    去巡检
                  </el-button>
                </div>
              </template>
      ...
      <el-tab-pane label="已巡检" name="second">
        <ContentWrap>
          ...
          >
            ...
            <el-table-column label="操作" align="center" fixed="right" min-width="154px">
              <template #default="scope">
                <el-button link type="primary" @click="getCheckLog(scope.row)">巡检日志</el-button>
              </template>
            </el-table-column>
          </el-table>
          <!-- 分页 -->
...
import { CheckDeviceV0, CheckLogsApi, CheckLogV01 } from '@/api/agriculture/checklogs';
