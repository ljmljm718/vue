...
const getList = async () => {
  loading.value = true;
  try {
    const data = await SalesManagementApi.getSalesManagementPage(queryParams);
...
const handleDelete = async (id: number) => {
  try {
    ...
    // 发起删除
    await SalesManagementApi.deleteSalesManagement(id);
...
const handleExport = async () => {
  try {
    ...
    const data = await SalesManagementApi.exportSalesManagement(queryParams);
    download.excel(data, '销售管理.xls');
  } catch {
  } finally {
  ...
  >
    <div class="w-full flex justify-between items-center">
      <div class="flex items-center">
        <!-- 一级标题名字 -->
        <h1 class="m-0 text-[#333] font-bold text-[18px]">销售数据</h1>
      ...
      <div class="flex items-center">
        ...
        <el-button @click="handleExport" v-hasPermi="['agriculture:sales-management:export']">
    ...
    >
      ...
      <el-form-item label="销售地" prop="salesLocation">
        <el-input
          v-model="queryParams.salesLocation"
          placeholder="请输入销售地"
          clearable
          @keyup.enter="handleQuery"
        />
          ...
          <template #default="scope">
            <div class="flex items-center justify-center">
              <el-button
                ...
                v-hasPermi="['agriculture:sales-management:update']"
              >
                编辑
              </el-button>
              ...
              <el-button
                ...
                v-hasPermi="['agriculture:sales-management:delete']"
              >
                删除
              </el-button>
            </div>
