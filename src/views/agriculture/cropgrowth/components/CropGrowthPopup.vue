...
import {CropGrowthVO, CropGrowthApi} from "@/api/agriculture/cropgrowth";
import {VarietyManagementVO} from "@/api/agriculture/varietymanagement";

defineOptions({name: 'CropGrowthPopup'})
...
/** 选中操作 */
const selectionList = ref<CropGrowthVO[]>([])
const handleSelectionChange = (rows: CropGrowthVO[]) => {
  selectionList.value = rows
}

/** 提交选择 */
const emits = defineEmits<{
  (e: 'success', value: CropGrowthVO[]): void
}>()
const submitForm = () => {
  try {
