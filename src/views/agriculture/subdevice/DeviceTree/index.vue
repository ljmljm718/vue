...
import SubDeviceInfo from "@/views/agriculture/subdevice/index.vue";

/** 设备信息 列表 */
defineOptions({name: 'SubDeviceView'})
...
const getCategoryList = async () => {
  ...
  try {
    ...
    const data = await ParkInfoApi.getDeviceAndParkTree(queryParams)
    console.log(data)
