<template>
  <Dialog :title="dialogTitle" v-model="dialogVisible" width="60%">
    ...
    <el-tabs v-model="subTabsName">
      <el-tab-pane label="指标要素范围" name="modelIndicatorElementRange">
        <ModelIndicatorElementRangeForm
          ref="modelIndicatorElementRangeFormRef"
          :indicator-element-id="formData.id"
        />
      </el-tab-pane>
    </el-tabs>
    <template #footer>
  ...
  <!--  选择设备-->
  <SelectDeviceInfoMultiple
    ref="deviceSelectRef"
    @success="handleDeviceSelectPopupChange"
    :device-monitor-type="formData.elementName"
  />
</template>
...
import { ModelMonitorIndicatorApi } from '@/api/agriculture/modelmonitorindicator';
