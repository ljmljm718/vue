  ...
  >
    <div class="w-full flex justify-between items-center">
      <div class="flex items-center">
        <!-- 一级标题名字 -->
        <h1 class="m-0 text-[#333] font-bold text-[18px]">基地分类</h1>
        ...
        <el-button
          ...
          v-hasPermi="['agriculture:park-category:create']"
        >
    ...
    >
      ...
      <el-form-item label="是否显示" prop="showStatus">
        <el-select v-model="queryParams.showStatus" placeholder="请选择是否显示" clearable>
          <el-option
          ...
          <template #default="scope">
            <div class="flex items-center justify-center">
              ...
              <el-button
                ...
                v-hasPermi="['agriculture:park-category:delete']"
              >
                删除
              </el-button>
            </div>
