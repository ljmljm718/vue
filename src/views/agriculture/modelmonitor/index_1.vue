          ...
          <div class="grow" style="width: calc(100% - 15.4rem)">
            <div class="flex justify-between items-center mt-3 px-6 overflow-hidden pb-[25px]">
              <div
                ...
                @click="handleFilterModelClick(ele),console.log('elelel',ele)"
              >
                <div
...
const getleftList = async () => {
  ...
  console.log("🚀 ~ getleftList ~ leftList:", leftList)
...
const getGrowthById = (id:string) => {
  const _activeItem = filteredModelList.value.find(item => item.growthId === id)
  if (_activeItem) return _activeItem.growth;
  return ''
}
