  ...
  >
    <div class="w-full flex justify-between items-center">
      <div class="flex items-center">
        <!-- 一级标题名字 -->
        <h1 class="m-0 text-[#333] font-bold text-[18px]">生产商入库</h1>
      ...
      <el-table v-loading="loading" :data="list" :stripe="true" :show-overflow-tooltip="true">
        ...
        <el-table-column label="审批状态" align="center" prop="approvalStatus" width="100">
          <template #default="scope">
            <dict-tag
              :type="DICT_TYPE.PRODUCER_ENTRY_APPROVAL_STATUS"
...
import activiti from '@/components/bpmnProcessDesigner/package/designer/plugins/extension-moddle/activiti';
