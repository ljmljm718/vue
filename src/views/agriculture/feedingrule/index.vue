...
<template>
  ...
  >
    <div class="w-full flex justify-between items-center">
      <div class="flex items-center">
        <!-- 一级标题名字 todo替换成菜单名称-->
        <h1 class="m-0 text-[#333] font-bold text-[18px]">投喂规则管理</h1>
          ...
          <template #default="scope">
            ...
            <div class="flex items-center justify-center">
              <el-button
                ...
                v-hasPermi="['agriculture:feeding-rule:update']"
              >
                编辑
              </el-button>
              <div class="mx-[12px] w-[1px] h-[24px] bg-[#e6e6e6]"></div>
              <el-button
                ...
                v-hasPermi="['agriculture:feeding-rule:delete']"
              >
                删除
              </el-button>
            </div>
  ...
  <!-- todo页面组件复制在下面 -->
  <!-- 表单弹窗-->
  <FeedingRuleForm ref="formRef" @success="getList" />
</template>
