      ...
      >
        <el-form-item label="品类名称" prop="categoryName">
          <el-input
            ...
            class="!w-240px"
          />
<!--          <el-select v-model="queryParams.categoryName" clearable placeholder="请选择品类" class="!w-240px">-->
<!--            <el-option-->
...
defineOptions({name: 'SelectCategoryManagement'})
...
/** 选中操作 */
const selectionList = ref<CategoryManagementVO[]>([])
const handleSelectionChange = (rows: CategoryManagementVO[]) => {
  selectionList.value = rows
}

/** 提交选择 */
const emits = defineEmits<{
  (e: 'success', value: CategoryManagementVO[]): void
}>()
const submitForm = () => {
  try {
