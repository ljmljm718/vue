...
<template>
  <el-row :gutter="20" v-loading="loading">
    <el-col :span="isCollapse ? 0 : 4" class="relative h-800px">
      <el-menu default-active="2" class="el-menu-vertical-demo relative h-100%" :collapse="isCollapse">
        <ContentWrap>
          <ContentWrap>
        ...
        class="  flex absolute bottom-0 left-50%  items-center justify-center w-145px h-35px rounded bg-[#e5f4f3] color-[#38aca1]"
