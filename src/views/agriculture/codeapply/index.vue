  ...
  >
    <div class="w-full flex justify-between items-center">
      <div class="flex items-center">
        <!-- 一级标题名字 -->
        <h1 class="m-0 text-[#333] font-bold text-[18px]">码申请</h1>
        ...
        <el-button
          ...
          v-hasPermi="['agriculture:code-apply:create']"
        >
    ...
    >
      ...
      <el-form-item label="溯源模版" prop="sourceId">
        <el-select v-model="queryParams.sourceId" placeholder="请选择溯源模版" clearable>
          <el-option
      ...
      <el-form-item label="码规则" prop="ruleId">
        <el-select v-model="queryParams.ruleId" placeholder="请选择码规则" clearable>
          <el-option
      ...
      <el-form-item label="状态" prop="applyStatus">
        <el-select v-model="queryParams.applyStatus" placeholder="请选择状态" clearable>
          <el-option
            v-for="dict in getStrDictOptions(DICT_TYPE.AGRI_CODE_APPLY_STATUS)"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
    ...
    <div class="w-full mt-[16px]">
      ...
      <el-table v-loading="loading" :data="list" :stripe="true" :show-overflow-tooltip="true">
        ...
        <el-table-column label="申请描述" align="center" prop="applyDescribe" width="350" />
              ...
              <el-popover :width="104" trigger="hover" popper-style="min-width: 0">
                ...
                <div class="flex flex-col items-start space-y-[8px] space-x-0">
                  <el-button
                    ...
                    v-hasPermi="['agriculture:code-apply:update']"
                  >
                    编辑
                  </el-button>
                  <el-button
...
const list = ref<CodeApplyVO[]>([]); // 列表的数据
...
const getList = async () => {
  loading.value = true;
  try {
    const data = await CodeApplyApi.getCodeApplyPage(queryParams);
...
const handleDelete = async (id: number) => {
  try {
    ...
    // 发起删除
    await CodeApplyApi.deleteCodeApply(id);
...
const handleExport = async () => {
  try {
    ...
    const data = await CodeApplyApi.exportCodeApply(queryParams);
    download.excel(data, '码申请.xls');
  } catch {
  } finally {
