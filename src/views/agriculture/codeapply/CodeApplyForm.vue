  ...
  <Dialog :title="dialogTitle" v-model="dialogVisible">
    ...
    >
      ...
      <el-form-item label="申请描述" prop="applyDescribe">
        <el-input v-model="formData.applyDescribe" placeholder="请输入申请描述" />
      </el-form-item>
      <el-form-item label="溯源模版" prop="sourceId">
        <el-input v-model="formData.sourceId" placeholder="请输入溯源模版" />
      </el-form-item>
      <el-form-item label="码规则" prop="ruleId">
        <el-input v-model="formData.ruleId" placeholder="请输入码规则" />
      </el-form-item>
      <el-form-item label="状态（制单/待发码/已发码）" prop="applyStatus">
        <el-select v-model="formData.applyStatus" placeholder="请选择状态（制单/待发码/已发码）">
          <el-option
