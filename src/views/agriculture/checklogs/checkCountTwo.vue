...
import {
  CheckDeviceV0,
  CheckLogsApi,
  CheckLogsCountPageVO, CheckLogsVO, CheckLogV01,
} from "@/api/agriculture/checklogs";
import {dateFormatter} from "@/utils/formatTime";
import {DICT_TYPE} from "@/utils/dict";
import CheckLogsFormLook from "@/views/agriculture/checklogs/CheckLogsFormLook.vue";
import CheckLogsFormL from "@/views/agriculture/checklogs/CheckLogsFormL.vue";
// 基地列表的数据
