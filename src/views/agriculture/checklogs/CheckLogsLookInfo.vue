            ...
            <el-row :gutter="3">
              ...
              <el-col :span="12">
                <el-form-item label="巡检结果状态" prop="resultState">
                  <el-select v-model="formData.resultState" placeholder="请选择巡检结果状态" disabled>
                    <el-option
              ...
              <el-col :span="12">
                <el-form-item label="巡检人id" prop="inspectorId">
                  ...
                  <el-input v-model="formData.inspectorId" readonly>
                    <template #append>
                      <el-button @click="openUserList" disabled>
                        <Icon icon="ep:search"/>
                        选择
                      </el-button>
                    </template>
...
<!--                  <el-image src="formData.inspectionImage"/>-->
...
/** 巡检记录 表单 */
defineOptions({name: 'CheckLogsLookInfo'})
// 本地保存表单
