  ...
  >
    <div class="w-full flex justify-between items-center">
      <div class="flex items-center">
        <!-- 一级标题名字 todo替换成菜单名称-->
        <h1 class="m-0 text-[#333] font-bold text-[18px]">巡检记录</h1>
    ...
    >
      ...
      <el-form-item label="巡检状态" prop="inspectionState">
        <el-select v-model="queryParams.inspectionState" placeholder="请选择巡检状态" clearable>
          <el-option
      ...
      <el-form-item label="巡检结果" prop="resultState">
        <el-select v-model="queryParams.resultState" placeholder="请选择巡检结果状态" clearable>
          <el-option
      ...
      <el-table v-loading="loading" :data="list" :stripe="true" :show-overflow-tooltip="true">
        ...
        <el-table-column label="操作" align="center" fixed="right" min-width="154px">
          <template #default="scope">
            ...
            <!-- todo方案一 -->
            <div class="flex items-center justify-center">
              <el-button link type="primary" @click="openFormA('update', scope.row.id)">
                详情
              </el-button>
              <div class="mx-[12px] w-[1px] h-[24px] bg-[#e6e6e6]"></div>
              <el-button
