<template>
    ...
    >
      ...
      <el-form-item>
        ...
        <el-button
          ...
          v-hasPermi="['agriculture:action-plan-table:create']"
        >
        ...
        <el-button
          ...
          v-hasPermi="['agriculture:action-plan-table:export']"
        >
      ...
      <el-table-column label="操作" align="center">
        <template #default="scope">
          <el-button
            ...
            v-hasPermi="['agriculture:action-plan-table:update']"
          >
            编辑
          </el-button>
          <el-button
            ...
            v-hasPermi="['agriculture:action-plan-table:delete']"
          >
            删除
          </el-button>
        </template>
  ...
  <!-- 表单弹窗：添加/修改 -->
  <ActionPlanTableForm ref="formRef" @success="getList" />
</template>
...
import ActionPlanTableForm from './ActionPlanTableForm.vue';
...
const handleExport = async () => {
  try {
    ...
    const data = await ActionPlanTableApi.exportActionPlanTable(queryParams);
    download.excel(data, '方案动作.xls');
  } catch {
  } finally {
