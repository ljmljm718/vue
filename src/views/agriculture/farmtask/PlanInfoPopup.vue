  ...
  >
    <ContentWrap>
      ...
      >
        ...
        <!--            <el-option-->
        <!--              v-for="dict in queryParams.grade === '0'-->
        <!--                ? getStrDictOptions(DICT_TYPE.KAIZHOU_PARK_BASE_TYPE).filter(-->
        <!--                    (item) => item.value.toString().substring(0, 4) === 'park'-->
        <!--                  )-->
        <!--                : getStrDictOptions(DICT_TYPE.KAIZHOU_PARK_BASE_TYPE).filter(-->
        <!--                    (item) => item.value.toString().substring(0, 6) === 'massif'-->
        <!--                  )"-->
        <!--              :key="dict.value"-->
        <!--              :label="dict.label"-->
        <!--              :value="dict.value"-->
