<template>
  ...
  <ContentWrap>
    ...
    >
      ...
      <el-form-item>
        ...
        <!--          v-hasPermi="['kaizhou:crop-base:create']"-->
        <!--        >-->
        ...
        <!--          v-hasPermi="['kaizhou:crop-base:export']"-->
        <!--        >-->
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :stripe="true" :show-overflow-tooltip="true" @selection-change="handleSelectionChange">
      ...
      <!--            v-hasPermi="['kaizhou:crop-base:update']"-->
      <!--          >-->
      <!--            编辑-->
      <!--          </el-button>-->
      <!--          <el-button-->
      ...
      <!--            v-hasPermi="['kaizhou:crop-base:delete']"-->
      <!--          >-->
      <!--            删除-->
      <!--          </el-button>-->
      <!--        </template>-->
...
import {PlantPlanVO} from "@/api/kaizhou/plantplan";

/** 作物管理 列表 */
defineOptions({name: 'CropBase'})
...
/** 提交选择 */
const emits = defineEmits<{(e: 'success', value: CropBaseVO[]): void}>()
const submitForm = () => {
  try {
