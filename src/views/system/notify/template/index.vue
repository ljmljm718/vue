<template>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column label="方案动作" align="center" prop="actionId" />
      ...
      <el-table-column label="允许播报" align="center" prop="broadcastStatus" width="80">
        <template #default="scope">
          <dict-tag :type="DICT_TYPE.COMMON_STATUS" :value="scope.row.broadcastStatus" />
        </template>
      </el-table-column>
      ...
      <el-table-column label="操作" align="center" width="220" fixed="right">
        <template #default="scope">
          ...
          <el-button link type="primary" @click="openSelectActionPlanTable(scope.row.id)">
            绑定方案
          </el-button>
        </template>
      </el-table-column>
  ...
  <SelectActionPlanTable ref="SelectActionPlanTableRef" @success="selectActionPlanTableSuccess()" />
</template>
...
//作物的品种选择
const SelectActionPlanTableRef = ref();
const openSelectActionPlanTable = (id: number) => {
  SelectActionPlanTableRef.value.open(id);
};
