...
const markNeedTextMap = new Map([
  ['1', '<div>枳壳的市场需求规模受到多种因素的影响，近年来呈现出一定的变化趋势。</div> <div style="text-indent:1em">从整体市场需求来看，过去有数据显示国内外市场枳壳总需求曾达30000吨以上。中国市场是全球枳壳市场的主要消费国，占据了约70%的市场份额。国内部分地区的相关信息也能从侧面反映枳壳的市场需求，例如江苏扬子江药业年用量在500吨左右，重庆太极集团涪陵制药年用量为500吨左右（主要用于急支糖浆）。</div><div style="text-indent:1em"> 就目前的市场情况而言，有报道称枳壳市场年需求量在5000吨左右。不过，由于枳壳前几年存在大面积扩种的情况，导致产量增加，目前市场处于供大于求的状态，行情较为低迷。近期各中药材市场上枳壳货源走销不快，商家关注力度一般。</div> <div style="text-indent:1em">总体来说，枳壳市场需求规模较大，但受到产量、市场行情等因素的影响，其实际的市场需求规模处于动态变化中。</div>'],
