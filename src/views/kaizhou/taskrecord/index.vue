    ...
    >
      ...
      <el-form-item>
        ...
        <el-button
          ...
          v-hasPermi="['kaizhou:task-record:create']"
        >
        ...
        <el-button
          ...
          v-hasPermi="['kaizhou:task-record:export']"
        >
      ...
      <el-table-column label="操作" align="center">
        <template #default="scope">
          <el-button
            ...
            v-hasPermi="['kaizhou:task-record:update']"
          >
            编辑
          </el-button>
          <el-button
            ...
            v-hasPermi="['kaizhou:task-record:delete']"
          >
            删除
          </el-button>
        </template>
...
const handleDelete = async (id: number) => {
  try {
    ...
    // 发起删除
    await TaskRecordApi.deleteTaskRecord(id)
...
const handleExport = async () => {
  try {
    ...
    const data = await TaskRecordApi.exportTaskRecord(queryParams)
    download.excel(data, '任务记录.xls')
  } catch {
  } finally {
