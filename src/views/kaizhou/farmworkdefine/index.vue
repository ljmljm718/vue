<template>
    ...
    >
      ...
      <el-form-item>
        ...
        <el-button
          ...
          v-hasPermi="['kaizhou:farm-work-define:create']"
        >
        ...
        <el-button
          ...
          v-hasPermi="['kaizhou:farm-work-define:export']"
        >
      ...
      <el-table-column label="操作" align="center">
        <template #default="scope">
          <el-button
            ...
            v-hasPermi="['kaizhou:farm-work-define:update']"
          >
            编辑
          </el-button>
          <el-button
            ...
            v-hasPermi="['kaizhou:farm-work-define:delete']"
          >
            删除
          </el-button>
        </template>
  ...
  <!-- 表单弹窗：添加/修改 -->
  <FarmWorkDefineForm ref="formRef" @success="getList" />
</template>
...
import FarmWorkDefineForm from './FarmWorkDefineForm.vue'

/** 农事定义 列表 */
defineOptions({ name: 'FarmWorkDefine' })
...
const handleDelete = async (id: number) => {
  try {
    ...
    // 发起删除
    await FarmWorkDefineApi.deleteFarmWorkDefine(id)
...
const handleExport = async () => {
  try {
    ...
    const data = await FarmWorkDefineApi.exportFarmWorkDefine(queryParams)
    download.excel(data, '农事定义.xls')
  } catch {
  } finally {
