<template>
  <div class="bg-[#0E1925] w-[100vw] h-[100vh]">
    <scale-box>
          ...
          <div class="relative top-[-10em] z-20 w-[32em] h-[32em]">
            ...
            <div class="up-down-frame">
              ...
              <div class="absolute center-bg w-[31em] h-[31em] left-[1em] top-[1em]">
                ...
                <div class="pedestal3"></div>
                <div class="pedestal4"></div>
              </div>
            </div>
            <!-- 分支 -->
            <div class="up-left-line cursor-pointer">
              <div class="sensor-bg relative left-[-11em] top-[-14em]" @click="routerHandler('智能感知')"></div>
            </div>
            <div class="up-right-line cursor-pointer">
              <div class="resource-bg relative left-[4em] top-[-14em]" @click="routerHandler('农业资源')"></div>
            </div>
            <div class="left-line cursor-pointer">
              <div class="agri-bg relative left-[-13em] top-[-4em]" @click="routerHandler('智慧农事')"></div>
            </div>
            <div class="right-line cursor-pointer">
              <div class="digital-bg relative right-[-13em] top-[-4em]" @click="routerHandler('数字产销')"></div>
            </div>
            <div class="down-left-line cursor-pointer">
              <div class="monitor-bg relative left-[-13em] top-[3em]" @click="routerHandler('视频监控')"></div>
            </div>
            <div class="down-right-line cursor-pointer">
              <div class="drive-bg relative left-[3em] top-[3em]" @click="routerHandler('可视化驾驶舱')"></div>
            </div>
            <!-- 两侧菜单 -->
            <div class="rect-bg text-[#fff] text-[1.2em] relative cursor-default">
              ...
              <!-- 选项菜单 -->
              <div class="lt-label-1 w-[10em] h-[2.4em] flex flex-row-reverse items-center pr-[2em] absolute left-[-10.1em] top-[2em] text-[1.4em]" @click="routerHandler('GIS一张图')">GIS一张图</div>
              <div class="lt-label-2 w-[10em] h-[2.4em] flex flex-row-reverse items-center pr-[2em] absolute left-[-11.4em] top-[5em] text-[1.4em]" @click="routerHandler('数字监测')">数字监测</div>
...
.circle-bg {
  background-image: url(./assets/homeV2/circle.png);
  background-size: 100% 100%;
  animation: spin 2s linear infinite;
}
.light-bg {
  background-image: url(./assets/homeV2/light-bg.png);
  background-size: 100% 100%;
  position: absolute;
  top: 14em;
  left: 5.6em;
...
.pedestal1 {
  background-image: url(./assets/homeV2/pedestal1.png);
  background-size: 100% 100%;
  position: absolute;
  top: 21.5em;
  left: 12.3em;
...
.pedestal2 {
  background-image: url(./assets/homeV2/pedestal2.png);
  background-size: 100% 100%;
  position: absolute;
  top: 20.8em;
  left: 9.4em;
...
.pedestal3 {
  background-image: url(./assets/homeV2/pedestal3.png);
  background-size: 100% 100%;
  position: absolute;
  top: 22.5em;
  left: 9.4em;
...
.pedestal4 {
  background-image: url(./assets/homeV2/pedestal4.png);
  background-size: 100% 100%;
  position: absolute;
  top: 22em;
  left: 6.5em;
...
.center-bg {
  background-image: url(./assets/homeV2/centerBg2.png);
  background-size: 100% 100%;
}
...
.up-left-line, .up-right-line, .down-left-line, .down-right-line, .left-line, .right-line {
  position: relative;
  background-size: 100% 100%;
  z-index: 999;
}
.up-left-line {
  background-image: url(./assets/homeV2/up-left-line.png);
  width: 9em;
  height: 8em;
  left: -7em;
  top: 12em;
...
.up-right-line {
  background-image: url(./assets/homeV2/up-right-line.png);
  width: 9em;
  height: 8em;
  left: 30em;
  top: 4em;
...
.left-line {
  background-image: url(./assets/homeV2/left-line.png);
  width: 16em;
  height: 3em;
  left: -13em;
  top: 8em;
...
.right-line {
  background-image: url(./assets/homeV2/right-line.png);
  width: 16em;
  height: 3em;
  left: 30em;
  top: 5em;
...
.sensor-bg { background-image: url(./assets/homeV2/sensor.png); }
.resource-bg { background-image: url(./assets/homeV2/resource.png); }
.monitor-bg { background-image: url(./assets/homeV2/monitor.png); }
.digital-bg { background-image: url(./assets/homeV2/digital.png); }
.agri-bg { background-image: url(./assets/homeV2/agri.png); }
.drive-bg { background-image: url(./assets/homeV2/drive.png); }

.sensor-bg, .resource-bg, .monitor-bg, .digital-bg, .agri-bg, .drive-bg {
  width: 16em;
  height: 17em;
  background-size: 100% 100%;
  &:hover {
...
.rect-bg {
  background-image: url(./assets/homeV2/rect.png);
  background-size: 100% 100%;
  width: 92.5em;
  height: 46em;
  aspect-ratio: 2.07;
...
.left-decorator {
  background-image: url(./assets/homeV2/left-decorator.png);
  background-size: 100% 100%;
  width: .8em;
  height: 10em;
  position: absolute;
...
.left-arrow {
  background-image: url(./assets/homeV2/left-arrow.png);
  background-size: 100% 100%;
  width: 0.8em;
  height: 1.6em;
  position: absolute;
...
.right-decorator {
  background-image: url(./assets/homeV2/right-decorator.png);
  background-size: 100% 100%;
  width: .8em;
  height: 10em;
  position: absolute;
...
.right-arrow {
  background-image: url(./assets/homeV2/right-arrow.png);
  background-size: 100% 100%;
  width: 0.8em;
  height: 1.6em;
  position: absolute;
...
@for $i from 1 through 7 {
  .icon-#{$i} {
    background-image: url(./assets/homeV2/icon#{$i}.png);
  }
}
...
// lb-label-1的背景图是lt-label-4的上下翻转，依次类推
$j: 4;
@for $i from 1 through 4 {
  .lt-label-#{$i} {
    background-image: url(./assets/homeV2/label#{$i}.png);
    background-size: 100% 100%;
  }
  .lt-label-#{$i}:hover {
    background-image: url(./assets/homeV2/slabel#{$i}.png);
    background-size: 100% 100%;
    color: #11F47F;
  }
  ...
  .lb-label-#{$i}::after {
    ...
    left: 0;
    z-index: -1;
    background: url(./assets/homeV2/label#{$i}.png) no-repeat center center;
    background-size: 100% 100%;
    transform:scaleY(-1);
  }
  .lb-label-#{$i}:hover::after {
    ...
    left: 0;
    z-index: -1;
    background: url(./assets/homeV2/slabel#{$i}.png) no-repeat center center;
    background-size: 100% 100%;
    transform:scaleY(-1);
  }
  .lb-label-#{$i}:hover {
