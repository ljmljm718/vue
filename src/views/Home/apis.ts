...
export const warningRecordInfoByCode = (params) => {
  return request.get({
    url: `/agriculture/warning-record-big-screen/warningRecordInfoByCode`,
    params
  });
};
...
export const getNumberByLandBlockId = (params) => {
  return request.get({
    url: '/agriculture/statistical-intermediate-table/get-number-by-landBlockId',
    params
  });
};
...
export const getSortNumberByDay = (params) => {
  return request.get({
    url: '/agriculture/statistical-intermediate-table/get-sort-number-by-day',
    params
  });
};
// 太塬村 病虫害排行 按照 周月查询
export const getNameQuantityByDateAndPlotId = (params) => {
  return request.get({
    url: '/agriculture/statistical-intermediate-table/get-name-quantity-by-date-and-plot-id',
    params
  });
};
// 太塬村 病虫害排行 按照 自定义查询
export const getSortNumberByCustomize = (params) => {
  return request.get({
    url: '/agriculture/statistical-intermediate-table/get-sort-number-by-customize',
    params
  });
};
...
export const devicePageList = (params) => {
  return request.get({ url: '/agriculture/device-info/pest-page', params });
};
...
// homeTongming 水肥一体化 首页

// 基本信息
export const getBaseInfo = () => {
  return request.get({ url: `/agriculture/wfi-console/get-base-info` });
};

// 当前灌区任务
export const getIrrigationAreaTask = () => {
  return request.get({ url: `/agriculture/wfi-console/get-irrigation-area-task` });
};

// 设备状态
export const getDeviceStatus = () => {
  return request.get({ url: `/agriculture/wfi-console/get-device-status` });
};

// 今日气象
export const getEnvironmentalDataHomePageA = () => {
  return request.get({ url: `/yyang/equipment-data/environmentalDataHomePageA` });
};

// 任务统计
export const getTask = () => {
  return request.get({ url: `/agriculture/wfi-console/get-task` });
};
