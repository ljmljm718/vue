    ...
    >
      ...
      <el-form-item label="销售地" prop="salesLocation">
        ...
        <el-cascader
          ...
          class="full-width"
          size="large"
          v-model="formData.salesLocation"
          placeholder="请选择销售地"
        />
      </el-form-item>
      ...
      <el-form-item label="总价(元)" prop="totalPrice">
        <el-input
          ...
          placeholder="跟据单价和数量自动计算，无需手动输入！"
          :disabled="true"
        />
      </el-form-item>
...
import VillageProductForm from '@/views/digital/villageproduct/VillageProductList/VillageProductList.vue';
...
const open = async (type: string, id?: number) => {
  ...
  if (id) {
    ...
    try {
      ...
      formData.value.salesLocation = [
        formData.value.provinceCode,
        formData.value.cityCode,
        formData.value.countiesCode
      ];
    } finally {
